...
- **Animations**: CSS Keyframes & Cubic-bezier transition
...
- **v2.3.0 (2026-03-05)**
  ...
  - [Feat] 新增會員中心歷史紀錄刪除功能與防呆彈窗。
  - [Fix] 徹底修復列表頁橫向捲軸問題，優化 RWD 斷點表現。
  - [Fix] 修正 Toast 通知定位，確保固定於視窗右上角且隨頁面捲動。
  - [Style] 優化管理員操作按鈕之 2x2 智慧佈局與奇數置中邏輯。

- **v2.2.1 (2026-03-05)**
  - [Style] 全面重構會員中心與問卷列表之 SCSS 結構。
  - [Style] 優化登入彈窗 (Login Modal) 之毛玻璃特效與視覺層次。
